        ...
        entities.forEach((ent) => {
            response
                ...
                .forEach((resp) => {
                    ...
                    if (columnTypes.isBoolean) options.isBoolean = true;
                    if (columnTypes.isString) options.isString = true;
                    if (columnTypes.isDate) options.isDate = true;
                    if (columnTypes.isNumber) options.isNumber = true;
                    ...
                    if (generated !== undefined) options.isGenerated = true;
